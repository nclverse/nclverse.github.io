...
}catch (e29590){if((e29590 instanceof Error)){
var e = e29590;
return null;
} else {
throw e29590;
...
figwheel.client.socket.open = (function open(p__29591){
var map__29593 = p__29591;
...
var opts = map__29593__$1;
var build_id = cljs.core.get.call(null,map__29593__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__29593__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__29593__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__29593__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count){
...
});})(url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count))
...
socket.onerror = ((function (url,socket,WebSocket,temp__4124__auto__,map__29593,map__29593__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1427852716563